			...
			<div class="carousel-inner">
				...
				<div class="item">
					...
					<div class="carousel-caption container">
						<div class="row">
							<div class="col-sm-7 padding-3">
								<p class="head carousel-content">iTravel Meals onboard</p>
		...
		<div class="container  col-sm-5 col-right " style="width:50%">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form:form method="POST" action="resetPassword" id="resetPassword"
						commandName="fp">
					<!-- <h7><font class="control-label col-sm-offset-1 col-sm-3 text-right fontstyle">Email&Phone Provided during registration with InfyGO<span
							...
							<div class="form-group">
								<form:label path="email"
									class="control-label col-sm-offset-1 col-sm-3 text-right fontstyle">Email Address<span
										class="red">*</span>
								</form:label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<form:input id="password" type="password" path="newPassword"
										class="form-control" />
									<br>
							...
							<div class="form-group">
								<div class="col-sm-offset-1">
									<font class="control-label text-right fontstyle">Please enter your Email Address and Phone number for confirmation</font>
								</div>
            ...
            <div class="text-center text-danger">${message}</div>  
				...
				<div id="success" class="alert alert-success col-md-12" align="center">${successMessage}
				<br>
				Click <a href="login" >
                        &nbsp;here </a>to login.
                  </div>
