								...
								<div class="col-sm-7 col-sm-offset-1">
									<form id="feedbackForm" class="feedback-form"
										...
										<div class="row">
											...
											<br> For what reasons do you fly? <br> <input
											...
											<br> How will you book your plane tickets? <br> <input
												type="radio" name="direct" value="direct" checked>
											Directly from the airline <br> <input type="radio"
												name="online" value="online "> Through an online
											travel discount site <br> <br> <br> How
											frequently will you fly with our airline? <br> <input
												type="radio" name="always1" value="always1" checked>
											Always <br> <input type="radio" name="most1"
												value="most1"> Most of the time <br> <input
												type="radio" name="half1" value="half1"> About half
											the time <br> <input type="radio" name="once1"
												value="once1"> Once in a while <br> <input
												type="radio" name="never1" value="never1"> Never <br>
											<br> <br> How frequently an additional fee is
											required to choose your own seat on the plane, when you fly
											with our airline? <br> <input type="radio"
												name="always2" value="always2" checked> Always <br>
											<input type="radio" name="most2" value="most2"> Most
											of the time <br> <input type="radio" name="half2"
												value="half2"> About half the time <br> <input
												type="radio" name="once2" value="once2"> Once in a
											while <br> <input type="radio" name="never2"
												value="never2"> Never <br> <br> <br>
											Do you feel that iTravel airlines is your most favorite? <br>
