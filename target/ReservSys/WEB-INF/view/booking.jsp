...
<h4><span class="glyphicon glyphicon-plus"></span> Booking Details </a></h4>
                  </div>
            ...
            <div class="col-sm-11 fontstyle text-right">
            <a href="${pageContext.servletContext.contextPath}/modifyBooking" class="btn btn-info">Modify Booking </a></div>
            </div>
            </form:form>
                  </div></div>
            </div>
        ...
        <table class="table">
        <thead>
            <tr><th>Name<span class="red">*</span></th>
            <th>Age<span class="red">*</span></th>
        ...
        <td><form:input    path="passengerList[${i.index}].passengerName"                            class="form-control" id="name${i.index}" required="true" title="Name must             contain 2 to 15 characters" pattern=".{2,15}"/></td>
        ...
        <c:if test="${passengerListContainer.passengerList.size() == 0}">
        <tr class="person defaultRow margintop-15 padding-3">
        <td><input type="text" name="passengerList[].name" value="" /></td>
        <td><input type="text" name="passengerList[].age" value="" /></td>                    <td><input type="text" name="passengerList[].gender" value="" /></td>
        <td><font><strong class="fontstyle" ><a href="#"class="removePerson" >Remove
        Passenger</a></strong></font></td>
        </tr></c:if>
        </tbody>
        ...
        style="margin-top: 2px; margin-left: 25px; padding:5px" name="proceed"                     value="Proceed To Pay">Proceed To Pay</button>
        </strong></font> <br> <br>
        </div>
